...
### [4] [Neutral-Atom-based Quantum Optimization for Resource Allocation in NOMA Networks](https://arxiv.org/abs/2609.26556)
...
### [5] [ZeroGate: Trust-Preserving Fast Paths for Governed AI Agent Runtimes](https://arxiv.org/abs/2609.25443)
*Zexun Wang*
...
### [6] [TCMaster: Confidence-Aware Querying and Workload-Guided Physical Design for Multi-Source Traditional Chinese Medicine Knowledge Graphs](https://arxiv.org/abs/2609.25712)
...
### [7] [OmniFysics-Nano-V2 Technical Report: Understanding the Physical World Across Modalities](https://arxiv.org/abs/2609.25738)
...
### [8] [AgenticSizing: A Large Language Model-based Multi-Agent Framework for Analog Circuit Sizing](https://arxiv.org/abs/2609.25873)
...
### [9] [The Probabilistic Structure of Large Language Models](https://arxiv.org/abs/2609.25134)
*Adnan Aboulalaâ*
...
### [10] [PACT: From Credit Assignment to Critic Alignment](https://arxiv.org/abs/2609.26355)
...
### [11] [DeepFEAv2: Deep Learning for Transient Finite Element Analysis Beyond Structured Meshes](https://arxiv.org/abs/2609.26426)
